            ...
            <div className='flex flex-col w-4/6 p-5 shadow-lg m-auto items-center justify-center'>
                ...
                <div className='w-5/6 shadow-lg px-10 pt-10 pb-20'>
                    <form>
                        ...
                        <div className='flex'>
                            <div className='block pr-5 w-1/2 text-2xl'>
                                <label>Start date/time</label>

                                <input className='mt-1 block w-full px-3 py-2 bg-white border border-slate-300 rounded-md text-2xl shadow-sm placeholder-slate-400
                                    focus:outline-none focus:border-sky-500 focus:ring-1 focus:ring-sky-500
                                    disabled:bg-slate-50 disabled:text-slate-500 disabled:border-slate-200 disabled:shadow-none
                                    invalid:border-pink-500 invalid:text-pink-600
                                    focus:invalid:border-pink-500 focus:invalid:ring-pink-500'
                            ...
                            <div className='block w-1/2 text-2xl'>
